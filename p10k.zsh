# Generated by Powerlevel10k configuration wizard on 2019-08-29 at 22:06 MST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 3868.
# Wizard options: nerdfont-complete + powerline, small icons, classic, darkest,
# vertical separators, sharp heads, flat tails, 2 lines, dotted, full frame, compact,
# many icons, concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      ...
      # context                 # user@host ~~~~~ doesn't work???
